...
function deposit(amount) {
    // Write function description 
    // For adding the amount to the current balance
    // Also add text that show that input amount been deposited
    // Code below this line vvvvv vvvvv vvvvv vvvvv vvvvv
    balance += amount;
...
function withdraw(amount) {
    // Write function description 
    // For withdrawing(removing) the amount from current balance
    // Also add text that show that amount been withdrawn
    // Code below this line vvvvv vvvvv vvvvv vvvvv vvvvv
    balance -= amount;
    transactionHistory.push(`Withdrawn ${amount} fromSavings Account`)
    // Code above this line ^^^^^ ^^^^^ ^^^^^ ^^^^^ ^^^^^
}

function getTransactionHistory() {
    // Write function description 
    // Show(Display) Transction action so that the user can see the history of the account
    // Code below this line vvvvv vvvvv vvvvv vvvvv vvvvv
    let show_trans = "Transaction History"; 
